...
set(MSG_I_FLAGS "-Ilsd_slam_viewer:/home/slam/lsd_slam_ws/src/LSD-SLAM/lsd_slam_viewer/msg")
...
get_filename_component(_filename "/home/slam/lsd_slam_ws/src/LSD-SLAM/lsd_slam_viewer/msg/keyframeMsg.msg" NAME_WE)
add_custom_target(_lsd_slam_viewer_generate_messages_check_deps_${_filename}
  COMMAND ${CATKIN_ENV} ${PYTHON_EXECUTABLE} ${GENMSG_CHECK_DEPS_SCRIPT} "lsd_slam_viewer" "/home/slam/lsd_slam_ws/src/LSD-SLAM/lsd_slam_viewer/msg/keyframeMsg.msg" ""
)

get_filename_component(_filename "/home/slam/lsd_slam_ws/src/LSD-SLAM/lsd_slam_viewer/msg/keyframeGraphMsg.msg" NAME_WE)
add_custom_target(_lsd_slam_viewer_generate_messages_check_deps_${_filename}
  COMMAND ${CATKIN_ENV} ${PYTHON_EXECUTABLE} ${GENMSG_CHECK_DEPS_SCRIPT} "lsd_slam_viewer" "/home/slam/lsd_slam_ws/src/LSD-SLAM/lsd_slam_viewer/msg/keyframeGraphMsg.msg" ""
)
...
if(genpy_INSTALL_DIR AND EXISTS ${CATKIN_DEVEL_PREFIX}/${genpy_INSTALL_DIR}/lsd_slam_viewer)
  install(CODE "execute_process(COMMAND \"/usr/bin/python2\" -m compileall \"${CATKIN_DEVEL_PREFIX}/${genpy_INSTALL_DIR}/lsd_slam_viewer\")")
  # install generated code
  install(
